...
<?php include "./includes/social-sidebar.php" ?>
...
.vertical-navbar::after {
    ...
    position: absolute;
    bottom: 0;
    /* Position the line at the bottom of the navbar */
    left: 0;
    width: 100%;
    /* Make the line span the entire width of the navbar */
    height: 3px;
    /* Adjust the thickness of the line */
    background-color: #ff5733;
    /* Set the color of the line */
    transform: scaleX(0);
    /* Initially, the line will be invisible */
    transform-origin: bottom right;
    /* Origin of scaling */
    transition: transform 0.3s ease-in-out;
    /* Smooth transition when the effect is triggered */
}
    ...
    <div class="row">
        ...
        <div class="col-5">
            <div class="hero-content">
                ...
                <div class="hero-btn">
                    <button class="btn"> Get A Free Quote <img src="./assets/images/btn-arrow.svg"
...
<div class="container section-padding">
    <div class="row">
            ...
            <div class="about-content">
                ...
                <div class="about-cards mb-3">
                    <div class="row">
                        <div class="col-6">
                            <div class="card-main">
                                <img src="./assets/images/expert-innovation.svg" alt="">
                                <h5>Expert Innovative Design Professionals</h5>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card-main">
                                <img src="./assets/images/deliver-industry.svg" alt="">
        ...
        <div class="col-5">
            <div class="img-group">
                <div class="img-right">
                    <img src="./assets/images/about-rightimg.png" class="hero-img" alt="">
                </div>
                <div class="img-left">
                    <img src="./assets/images/about-leftimg.png" class="hero-img" alt="">
                </div>
                ...
                <div class="swiper-wrapper swiper-wrapper-padding-bottom">
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-1.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-2.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-3.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-4.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-5.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card card">
                            ...
                            <img src="./assets/images/service-6.png" class="card-img-bottom" alt="...">
                            <div class="service-btn">
                                <a href="javascript:;" class="know-more-btn">Know More <img class="ps-2"
                                        src="./assets/images/btn-arrow.svg" alt=""></a>
                            </div>
...
<div class="container section-padding">
    ...
    <div class="technology pt-5">
        <div class="next-prev-btn">
            <div class="prev-btn swiper-button-prev-tech"><img src="./assets/images/left-arrow.svg" alt="">
            </div>
            <div class="next-btn swiper-button-next-tech"><img src="./assets/images/right-arrow.svg" alt="">
            </div>
        </div>
...
<div class="recent-project-section">
            ...
            <div class="col-12">
                <div class=" blogs-content recent-project recent-project-content-bg-text">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="next-prev-btn">
                            <div class="prev-btn swiper-button-prev"><img src="./assets/images/left-arrow.svg"
                                    alt=""></div>
                            <div class="next-btn swiper-button-next"><img src="./assets/images/right-arrow.svg"
                                    alt=""></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="swiper mySwiperworks">
        <div class="swiper-wrapper">
                ...
                <div class="project-content">
                    ...
                    <div class="right-side">
                        <button class="btn btn-explore-more"> Explore More <img
                                src="./assets/images/btn-arrow.svg" class="btn-arrow" alt=""></button>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                <img src="./assets/images/portfolio5.png" alt="">
                <div class="project-content">
                    <div class="left-side">
    ...
    <div class="container section-padding">
        ...
        <div class="blog-cards pt-4">
            <div class="view-all-btn">
                <a href="javascript:;">VIEW ALL &nbsp; <img src="./assets/images/right-arrow.svg" alt=""></a>
            </div>
            <div class="row">
                <div class="col-4">
                    <div class="blog-card card text-bg-dark rounded-0">
                        <div class="overlay"></div>
                        <img src="./assets/images/blog-img-1.png" class="card-img rounded-0" alt="...">
                        <div class="card-img-overlay">
                            ...
                            <div class="card-date-auther">
                                <div class="blog-date">
                                    <img src="./assets/images/time-blog.svg" alt="">
                                    <p>17 April, 2025</p>
                                </div>
                                <div class="blog-auther">
                                    <img src="./assets/images/person-blog.svg" alt="">
                                    <p>David Johnson</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-4">
                    <div class="blog-card card text-bg-dark rounded-0">
                        <div class="overlay"></div>
                        <img src="./assets/images/blog-img-2.png" class="card-img rounded-0" alt="...">
                        <div class="card-img-overlay">
                ...
                <div class="col-4">
                    <div class="blog-card card text-bg-dark rounded-0">
                        <div class="overlay"></div>
                        <img src="./assets/images/blog-img-3.png" class="card-img rounded-0" alt="...">
                        <div class="card-img-overlay">
...
<div class="contact-container-bg-color ">
    <div class="container margin-top-bottom bg-blob">
        <div class="row">
            <div class="col-5">
                <div class="contact-image">
                    <img src="./assets/images/contact-image.png" class="hero-img" alt="">
                    <div class="overlay"></div>
                    <div class="on-image-text">
                        <h4 class="m-0">Get in touch by calling on
                        </h4>
                        <div class="gradiant-text">+64 (0) 21875514 </div>
                        <p>or filling out the form—we’ll respond as quickly as possible.</p>
                    </div>
                </div>
            </div>
            <div class="col-7 bg-grid ">
                <div class="contact-content">
                    <div class="heading-top">
                        GET A FREE QUOTE
                    </div>
                    <div class="heading">
                        Let's Build Something Great – Request Your Free Quote!
                    </div>
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control" id="" placeholder="Enter Name">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label">Mobile Number</label>
                            <input type="text" class="form-control" id="" placeholder="Enter Number">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <label for="" class="form-label">Email <span
                                    class="fw-light sm-text">(Required)</span></label>
                        ...
                        <div class="col-12">
                            <div class="hero-btn pt-2">
                                <button class="btn" type="submit">Get A Quote <img
                                        src="./assets/images/btn-arrow.svg" class="btn-arrow" alt=""></button>
                            </div>
                        </div>
                    </form>
